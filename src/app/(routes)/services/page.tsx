     ...
     <Cover/>
      ...
      <div className="grid items-center justify-center h-screen max-w-5xl gap-8 mx-auto md:grid-cols-2">
        <div className="max-w-[450px]">
          ...
          <h1 className="mt-[150px] px-5 text-2xl leading-tight text-center md:text-left md:text-4xl md:mb-5">Mis <span className="font-bold text-secondary"> servicios.</span></h1>
